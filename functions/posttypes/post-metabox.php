...
$meta_box = array(
    'id' => 'meta-box-video',
    'title' => esc_html__( 'Themnific Post Options','dotorg' ),
    'page' => 'post',
    'context' => 'normal',
    'priority' => 'high',
    'fields' => array(	
		...
		array(
			'name' => '',
			'desc' => esc_html__( 'Sidebar / Featured Image Options','dotorg' ),
			...
			'std' => ''
				...
				array(
					'name' => esc_html__( 'Post sidebar','dotorg' ),
					'desc' => '',
					'id' => $prefix . 'sidebar',
					'type' => 'select',
					'std' => '',
				...
				array(
					'name' => esc_html__( 'Show featured image in Single post','dotorg' ),
					'desc' => esc_html__( 'Optional usage.','dotorg' ),
		...
		array(
			'name' => '',
			'desc' => esc_html__( 'Post  Formats','dotorg' ),
			'id' => 'themnific_fomats_section',
			'type' => 'heading',
			'std' => ''
		),
				...
				array(
					'name' => esc_html__( 'Link','dotorg' ),
					'desc' => esc_html__( 'Insert the URL you wish to link to.','dotorg' ),
					'id' => $prefix . 'linkss',
					'type' => 'text',
					'std' => ''
				),	
		...
		array(
			'name' => '',
			'desc' => esc_html__( 'Advertisement - override Post Static Ad (set in Admin panel)','dotorg' ),
			'id' => 'themnific_ads_section',
			'type' => 'heading',
			'std' => ''
		),	
				
				array(
					'name' => esc_html__( 'Ad Banner','dotorg' ),
					'desc' => esc_html__( 'You can add 728px wide image here - paste URL of the image.','dotorg' ),
				...
				array(
					'name' => esc_html__( 'Ad Target URL','dotorg' ),
					'desc' => esc_html__( 'Paste target URL.','dotorg' ),
