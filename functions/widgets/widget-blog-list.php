<?php
add_action('widgets_init', 'dotorg_blog_list');

function dotorg_blog_list()
{
	register_widget('dotorg_blog_list');
}

class dotorg_blog_list extends WP_Widget {
	
	public function __construct() {
		$widget_ops = array('classname' => 'dotorg_blog_list', 'description' => esc_html__('!!Posts block for Elementor only!!','dotorg'));
       	parent::__construct(false, esc_html__('Themnific: Blog List','dotorg'),$widget_ops);  
	}
	...
	function form($instance)
	{
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('offset_posts')); ?>"><?php esc_html_e('Offset posts','dotorg'); ?></label>
