...
class dotorg_ad_300 extends WP_Widget {

	public function __construct() {
		$widget_ops = array('description' => esc_html__('Use this widget to add any type of Ad as a widget.','dotorg') );
		parent::__construct(false, esc_html__('Themnific: Ads 300px/Free','dotorg'),$widget_ops);      
	}
	...
	function form($instance) {    
		...
		<p>
            <label for="<?php echo esc_attr($this->get_field_id('adcode')); ?>"><?php esc_html_e('Ad Code:','dotorg'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('image')); ?>"><?php esc_html_e('Image Url:','dotorg'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('href')); ?>"><?php esc_html_e('Link URL:','dotorg'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('alt')); ?>"><?php esc_html_e('Alt text:','dotorg'); ?></label>
